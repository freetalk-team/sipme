import { Events, getOptions as getOptions$1, createPicker, FocusTrap, animate } from './picmo.js';
...
class PopupEvents extends Events {
}
...
function setPosition(picker, referenceElement, position) {
    if (!position) {
...
function setRelativePosition(picker, referenceElement, placement) {
    if (!referenceElement) {
...
function setFixedPosition(picker, position) {
...
function getOptions(options = {}) {
    return Object.assign(Object.assign(Object.assign({}, defaultOptions), { rootElement: document.body }), options);
}
...
var classes = {"popupContainer":"popupPicker_popupContainer__-DboI","closeButton":"popupPicker_closeButton__j1nuQ"};
...
class PopupPickerController {
    constructor(pickerOptions, popupOptions) {
        this.isOpen = false;
        this.externalEvents = new PopupEvents();
        this.options = Object.assign(Object.assign({}, getOptions(popupOptions)), getOptions$1(pickerOptions));
        ...
        this.picker = createPicker(Object.assign(Object.assign({}, this.options), { rootElement: pickerContainer }));
    ...
    open() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.initiateOpenStateChange(true);
            this.options.rootElement.appendChild(this.popupEl);
            this.setPosition();
            this.picker.reset();
            yield this.animatePopup(true);
            yield this.animateCloseButton(true);
            this.picker.setInitialFocus();
    ...
    close() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.initiateOpenStateChange(false);
            yield this.animateCloseButton(false);
            yield this.animatePopup(false);
            this.popupEl.remove();
            this.picker.reset();
            (_a = this.positionCleanup) === null || _a === void 0 ? void 0 : _a.call(this);
            this.focusTrap.deactivate();
            (_b = this.options.triggerElement) === null || _b === void 0 ? void 0 : _b.focus();
    ...
    onDocumentClick(event) {
        ...
        const isClickOnTrigger = (_a = this.options.triggerElement) === null || _a === void 0 ? void 0 : _a.contains(clickedNode);
        if (this.isOpen && !this.picker.isPickerClick(event) && !isClickOnTrigger) {
            this.close();
        }
    }
    animatePopup(openState) {
     ...
     */
    initiateOpenStateChange(openState) {
        return __awaiter(this, void 0, void 0, function* () {
            this.isOpen = openState;
            yield this.awaitPendingAnimations();
        });
    }
}

function createPopup(pickerOptions, popupOptions) {
    const popup = new PopupPickerController(pickerOptions, popupOptions);
    return popup;
}

export { PopupPickerController, createPopup };
